...
export const ChatInfo = () => {
  ...
  return (
    <div className="flex flex-col w-full max-w-sm p-4 overflow-y-scroll border-l border-gray-200 scrollbar scrollbar-thin scrollbar-track-transparent scrollbar-thumb-slate-200">
